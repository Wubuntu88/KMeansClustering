...
public class KMeansIO {
    ...
    public KMeansIO(String fileName) throws Exception {
	String whitespace = "[ ]+";
    ...
    public KMeansClusterer instantiateKMeansClusterer() {
	KMeansClusterer kmc = new KMeansClusterer(this.records);
	return kmc;
    }
	...
	String str = this.clusterResultsString(denormalizedRecords, clustersThatRecordsBelongTo, numberOfClusters);
	pw.print(str);
	pw.close();
    }

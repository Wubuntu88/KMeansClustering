...
public class Driver1 {
	...
	// int[] clustersRecordsBelongTo =
	// kmc.clustersThatRecordsBelongToCopy();
	// int numClusters = kmc.getNumberOfClusters();
	// kmIO.writeClusteredRecordsToFile(outputFile, denormalizedRecords,
	// clustersRecordsBelongTo, numClusters);
    }
}